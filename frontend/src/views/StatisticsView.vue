...
export default {
  ...
  methods: {
    uploadFile(file) {
      ...
      axios.post('http://' + this.$store.state.host + ':5000/api/upload', formData, {
        headers: {
    ...
    generateImages() {
  axios.post('http://' + this.$store.state.host + ':5000/api/generate-images')
    .then(response => {
    ...
    fetchFieldingStats() {
      axios.get('http://' + this.$store.state.host + ':5000/api/player_fielding_stats', { params: { player_name: this.playerName } })
        .then(response => {
    ...
    fetchPitchingStats() {
      axios.get('http://' + this.$store.state.host + ':5000/api/player_pitching_stats', { params: { player_name: this.playerName } })
        .then(response => {
    ...
    fetchBattingStats() {
      axios.get('http://' + this.$store.state.host + ':5000/api/player_batting_stats', { params: { player_name: this.playerName } })
        .then(response => {
