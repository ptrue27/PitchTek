...
class DataVisualizer:
    ...
    def generate_images(self):
        ...
        self._generate_count_vs_description_heatmap()
        self._generate_pitch_velocity_chart()

    def _generate_heatmap_of_counts(self):
        df = self.df
    ...
    def _generate_count_vs_description_heatmap(self):
        df = self.df
        df['count'] = df['balls'].astype(str) + '-' + df['strikes'].astype(str)
    ...
    def _generate_pitch_velocity_chart(self):
